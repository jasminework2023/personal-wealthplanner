...
export function AddTransactionModal({
  ...
  const categories = availableCategories?.length ? availableCategories : [
    "Gajian", "Freelance Income", "Business Income", "Dividend / Interest", "Utilities", "Internet & Phone",
    "Insurance Premium", "Food & Groceries", "Transport", "Entertainment", "Education", "Charity", "Mutual Funds", "Gold", "Deposito"
  ];
