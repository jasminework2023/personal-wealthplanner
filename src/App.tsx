...
function CalculatorRoute() {
  ...
  if (id) return <CalculatorDetail id={id} onBack={() => navigate("/calculator")} onSaveResult={saveResult} onNavigate={(action: any) => { if (action?.name === "protection") navigate(`/protection?plan=${encodeURIComponent(action.calculatorId || id)}`); }} />;
